...
def endLog():
    ...
    newFilename = os.path.join('logs', "log "+dt+".txt")
...
def masLargo(stack):
    ...
    print("\n---Texto del elemento más largo de la pila [índice: {}, largo: {}]---\n".format(str(stack.index(lar)),str(len(lar))))
    print(lar)
...
def masCorto(stack):
    ...
    print("---Texto del elemento más corto de la pila [índice: {}, largo: {}]---\n".format(str(stack.index(shor)),str(len(shor))))
    print(shor)
